      ...
      if ($("#sidebar").hasClass("close")) {
        $("#logo_sidebar")
          .fadeOut(150, function () {
            ...
            $("#logo_sidebar").css("margin-right", "80px");
          })
          .fadeIn(150);
      } else {
        $("#logo_sidebar")
        ...
        if ($("#sidebar").hasClass("close")) {
          $("#logo_sidebar")
            .fadeOut(150, function () {
              ...
              $("#logo_sidebar").attr("width", "40");
              $("#logo_sidebar").css("margin-right", "2px");
            })
            .fadeIn(150);
        } else {
          $("#logo_sidebar")
            .fadeOut(150, function () {
              $("#logo_sidebar").attr("src", "Assets/Private/img/logo.png");
              $("#logo_sidebar").attr("width", "200");
              $("#logo_sidebar").css("margin-left", "0px");
            })
            .fadeIn(150);
          $("#img_login")
            .fadeOut(100, function () {
        ...
        if ($("#sidebar").hasClass("close")) {
          $("#logo_sidebar")
            .fadeOut(150, function () {
              $("#logo_sidebar").attr("src", "Assets/Private/img/logo-pabar.png");
              $("#logo_sidebar").attr("width", "40");
              $("#logo_sidebar").css("margin-right", "0px");
            })
            .fadeIn(100);
        } else {
          $("#logo_sidebar")
        ...
        .fadeOut(150, function () {
          if ($("#sidebar").hasClass("close")) {
            if ($("body").hasClass("dark-theme")) {
              $("#logo_sidebar").attr("src", "Assets/Private/img/logo-pabar.png");
              $("#logo_sidebar").attr("width", "40");
              $("#logo_sidebar").css("margin-right", "-10px");
            } else {
              $("#logo_sidebar").attr("src", "Assets/Private/img/logo-pabar.png");
              $("#logo_sidebar").attr("width", "40");
              $("#logo_sidebar").css("margin-left", "13px"); //pertama white
            }
          } else {
            if ($("body").hasClass("dark-theme")) {
              $("#img_login").attr("src", "Assets/Private/img/auth-img-dark.png");
              ...
              $("#logo_sidebar").attr("src", "Assets/Private/img/logo.png");
              $("#logo_sidebar").attr("width", "200");
              $("#logo_sidebar").css("margin-left", "0px"); //awal bgt
            }
          }
        })
        .fadeIn(150);
