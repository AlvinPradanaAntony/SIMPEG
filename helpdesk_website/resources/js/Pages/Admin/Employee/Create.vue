  ...
  <DashboardLayout title="Employee Create">
    ...
    <div class="card custom">
      <div class="card-header px-4 py-4">
        <h3 class="m-0 fw-bold fs-5">Form Buat Employee</h3>
      </div>
        ...
        <form @submit.prevent="submit">
          <div class="row">
            <div class="col-lg-6 mb-3">
              ...
              <TextInput ref="employeeInput" type="text" class="form-control" id="name" v-model="form.name" required
          ...
          <div class="row">
            <div class="col-lg-6 mb-3">
              ...
              <TextInput ref="employeeInput" type="text" class="form-control" id="nip" v-model="form.nip" required
          ...
          <div class="row">
            <div class="col-lg-6 mb-3">
              ...
              <TextInput ref="employeeInput" type="text" class="form-control" id="birth_place" v-model="form.birth_place" required
            ...
            <div class="col-lg-6 mb-3">
              ...
              <TextInput ref="employeeInput" type="date" class="form-control" id="birth_date" v-model="form.birth_date" required
          ...
          <div class="row">
            <div class="col-lg-6 mb-3">
              ...
              <TextInput ref="employeeInput" type="text" class="form-control" id="phone" v-model="form.phone" required
                autocomplete="phone" @keyup.enter="submit" />
              <InputError :message="form.errors.phone" class="mt-2" />
            </div>
            <div class="col-lg-6 mb-3">
              <InputLabel for="address" class="form-label small" value="Alamat" />
                <TextInput ref="employeeInput" type="text" class="form-control" id="address" v-model="form.address" required
          ...
          <div class="row">
            <div class="col-lg-6 mb-3">
              ...
              <TextInput ref="employeeInput" type="email" class="form-control" id="email" v-model="form.email" required
                autocomplete="email" @keyup.enter="submit" />
              <InputError :message="form.errors.email" class="mt-2" />
            </div>
            <div class="col-lg-6 mb-3">
              <InputLabel for="password" class="form-label small" value="Password" />
              <TextInput ref="employeeInput" type="password" class="form-control" id="password" v-model="form.password" required
          ...
          <div class="row">
            <div class="col-lg-6 mb-3">
              ...
              <TextInput ref="employeeInput" type="password" class="form-control" id="confirmPassword" v-model="form.password_confirmation" required
