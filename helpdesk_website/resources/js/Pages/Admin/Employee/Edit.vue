...
const update = () => {
  edit.put(route('admin.pegawai.update', {id:edit.id}), {
    preserveScroll: true,
...
<template>
  <DashboardLayout title="Employee Create">
    <div class="card custom mb-3 px-2">
      <div class="card-body">
        <h3 class="m-0 fw-bold fs-5">
          <Link :href="route('admin.pegawai')" class="text-decoration-none">Halaman Manajemen Employee</Link>
          <span> / </span> Ubah
        </h3>
      </div>
    </div>
    <div class="card custom">
      <div class="card-header px-4 py-4">
        <h3 class="m-0 fw-bold fs-5">Form Ubah Employee</h3>
      </div>
        ...
        <form @submit.prevent="update">
          <div class="row">
            <div class="col-lg-6 mb-3">
              ...
              <TextInput ref="employeeInput" type="text" class="form-control" id="name" v-model="edit.name" required
          ...
          <div class="row">
            <div class="col-lg-6 mb-3">
              ...
              <TextInput ref="employeeInput" type="text" class="form-control" id="nip" v-model="edit.nip" required
          ...
          <div class="row">
            <div class="col-lg-6 mb-3">
              ...
              <TextInput ref="employeeInput" type="text" class="form-control" id="birth_place" v-model="edit.birth_place" required
            ...
            <div class="col-lg-6 mb-3">
              ...
              <TextInput ref="employeeInput" type="date" class="form-control" id="birth_date" v-model="edit.birth_date" required
          ...
          <div class="row">
            <div class="col-lg-6 mb-3">
              ...
              <TextInput ref="employeeInput" type="text" class="form-control" id="phone" v-model="edit.phone" required
            ...
            <div class="col-lg-6 mb-3">
              <InputLabel for="address" class="form-label small" value="Alamat" />
                <TextInput ref="employeeInput" type="text" class="form-control" id="address" v-model="edit.address" required
          ...
          <div class="row">
            <div class="col-lg-6 mb-3">
              ...
              <TextInput ref="employeeInput" type="email" class="form-control" id="email" v-model="edit.email" required
            ...
            <div class="col-lg-6 mb-3">
              ...
              <TextInput ref="employeeInput" type="password" class="form-control" id="password" v-model="edit.password" required
          ...
          <div class="row">
            <div class="col-lg-6 mb-3">
              ...
              <TextInput ref="employeeInput" type="password" class="form-control" id="confirmPassword" v-model="edit.password_confirmation" required
